...
// };
    ...
    <p className="mb-5 md:mb-10 text-center">
        <Image src={Logo} alt="animate" className="mx-auto max-w-[172px]"/>
          ...
          <h2 className="text-[#3C3F88] text-center font-[700] text-[30px] mb-5 md:mb-10 ">Change Password</h2>
        <div className="login rounded-[20px] bg-white">
          ...
          <button className="button mt-[50px] w-full" onClick={handlePopup}>Change Password</button>
          </div>
        </div>
          </div>
        </div>
